...
void runInteractiveTest()
{
  ...
  // Kebab* testKebab;
  // testKebab = new Kebab();
  // testKebab->buildKebab("BT");
  // Kebab* testKebab1;
  // testKebab1 = new Kebab();
  // testKebab1->buildKebab("BTP");
  // testKebab->addIngredient('M');
  // std::cout << testKebab->listIngredients() << std::endl;
  // std::cout << testKebab->numMeats() << std::endl;
  // std::cout << testKebab->hasSameIngredients(*testKebab1) << std::endl;
  // std::cout << testKebab1->hasSameIngredients(*freshkebab) << std::endl;
